...
| 51 | 2026-05-22 | Git | **PR 생성** | A-01 과 New_Feature 브랜치 PR 생성 (gh 미인증) |
| 52 | 2026-05-22 | Git | **커밋·push** | 커밋 푸시 진행 (작업규칙 8단계) |
| 53 | 2026-05-22 | Git | **PR 재요청** | PR 도 생성되었나요? 안되었으면 진행 |
...
- **산출물**: `Filters.java`, `report/02_GREEN_bugfix_report.md`, `docs/08_GREEN_test_results.md`
...
| 30 | JUnit, JaCoCo 90.9%, `report/01_RED_coverage_report.md` |
